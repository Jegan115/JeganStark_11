...
if "messages" not in st.session_state:
    ...
    st.session_state.messages.append({
        "role": "assistant",
        "content": "Hello! I'm RIN NOHARA,your AI assistant. How can I help you today?",
...
def get_bot_response(user_message):
    ...
    if any(word in user_message_lower for word in ["hello", "hi", "hey", "greetings"]):
        return "Hello there! Nice to meet you. I'll Watch over you alwayss!"
    
    elif any(word in user_message_lower for word in ["Rin Will you Watch over me..?"]):
        return "Don't worry obito. I'll Watch over you alwayss!"
    ...
    elif re.match(r'^[\d\s\+\-\*/\.]+$', user_message.strip()):
        try:
            result = eval(user_message)
            return f"The answer is: {result}"
        except:
            return "Hmm, something went wrong with that calculation."
...
# App header
st.title("🙋🏻‍♀️ RIN AI Chatbot")
st.markdown("ＢＹ ＪＥＧＡＮ ＳＴＡＲＫ")
st.markdown("---")
    ...
    for message in st.session_state.messages:
        if message["role"] == "user":
            ...
            <div class="chat-message user-message">
                <div class="message-avatar user-avatar">🙍🏻‍♀️</div>
...
st.markdown(
    ...
    "🙍🏻‍♀️ Don't worry I'll always be watching you...!"
    "</div>", 
    unsafe_allow_html=True
)